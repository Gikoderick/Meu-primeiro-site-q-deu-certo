...
正常に登録されました!!</h3></b>
			...
			<br>
			<br>
        <a class="nav-link" style="color:orange;"href="index.html" align="center"><b>Voltar<b></a>
			</div>
<?php 
$servidor="localhost";
$usuario="root";
...
$sql = mysqli_query($conexao, "INSERT INTO usuarios (usuario,email,senha) VALUES ('$usuario','$email','$senha')");
